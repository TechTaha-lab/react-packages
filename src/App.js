...
function configure(options = {}) {
  ...
  if (Object.prototype.hasOwnProperty.call(options, "sanitizer") && typeof options.sanitizer === "function") {
...
function createTid(namespace) {
  ...
  builder.with = (parts, extraProps) => tid(joinParts([base, ...(Array.isArray(parts) ? parts : [parts])]), extraProps);
